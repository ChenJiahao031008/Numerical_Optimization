...
namespace cubic_spline
{
    ...
    public:
        ...
        inline void getGrad(Eigen::Ref<Eigen::Matrix2Xd> gradByPoints) const
        {
            ...
            Eigen::MatrixXd partial_D = A_inv * partial_B;
            // std::cout << "partial_D : " << partial_D.rows() << " x " << partial_D.cols() << std::endl;
            ...
            // std::cout << "partial_diff_x : " << partial_diff_x.rows() << " x " << partial_diff_x.cols() << std::endl;
            ...
            // std::cout << "partial_c : " << partial_c.rows() << " x " << partial_c.cols() << std::endl;
            // std::cout << "partial_d : " << partial_d.rows() << " x " << partial_d.cols() << std::endl;
            ...
            // std::cout << "gradByPoints : " << gradByPoints.rows() << " x " << gradByPoints.cols() << std::endl;
        }
    };
}
